#ifndef _SOP_MARKERDETECTFILTER_HEADER
#define _SOP_MARKERDETECTFILTER_HEADER
#define OID_ADTF_MARKERDETECTFILTER "adtf.sop.markerDetector"
...
*/
class SOP_MarkerDetector : public cFilter
{

    /*! declare the filter version */
    ADTF_DECLARE_FILTER_VERSION(OID_ADTF_MARKERDETECTFILTER, "SOP Marker Detector", adtf::OBJCAT_Tool, "SOP Marker Detection Filter", 1, 0, 1, "");
public:

    /*! default constructor
    * \param __info info argument for filter
    */
    SOP_MarkerDetector(const tChar* __info);

    /*! default destructor */
    virtual ~SOP_MarkerDetector();
